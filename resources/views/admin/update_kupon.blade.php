                ...
                <div class="row" style="text-align: center; padding-left: 20px; padding-right: 20px;">
                    <div class="card mt-4 shadow-lg" style="border-radius: 20px;  border: 3px solid">
                        <div class="card-header bg-dark text-light shadow-lg mt-3" style="border-radius: 20px; font-family: times new roman; margin-bottom:10px">
                            ...
                            <form method="POST" action="{{ route('kuponupdate', ['kategori' => $user->kategori]) }}">
                                @csrf
                                ...
                                <div class="mb-3">
                                    <input value="{{ $user->kategori }}" name="kategori" type="text" class="form-control shadow-lg" id="kategori" placeholder="Kategori" required>
                                </div>
                                ...
                                <div class="mb-3">
                                  <input value="{{ $user->harga }}" name="harga" type="text" class="form-control shadow-lg" id="Harga" placeholder="Harga Tiket" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    <textarea name="lokasi" class="form-control shadow-lg" id="lokasi" rows="4" placeholder="Lokasi Acara" required>{{ $user->lokasi }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <input value="{{ $user->tanggal }}" name="tanggal" type="date" class="form-control shadow-lg" id="tanggal" required>
                                </div>
