   ...
   <!--bagian awal navigasi bar--> 
    <nav class="navbar navbar-expand-lg navbar-dark  text-light sticky-top " style="background-color:  #3c3d3ee8">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Budaya Nusantara</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}">EVENT</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}">POSTER</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}">KONTAK</a>
              </li>
   ...
   <div class="container-fluid bg-dark text-light" style="height: 100vh; ">
    ...
    <div class="row align-items-center mt-2 ">
      <div class="col-12 text-center">
       ...
       <p>Welcome to my website Fotografer</p>
       <br>
    </div>
    </div>
    </div>
    ...
    <div class="col-md-4 g-5">
      <div class="card mt-4" style=" border-radius: 20px; background-color: bisque;">
        ...
        <div class="card-body">
          <h2 class="card-text text-dark text-center">Kupon Discount</h2>
          <p class="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          <a href="{{ route('login') }}" class="btn btn-outline-dark d-block">Klaim Kupon</a>
    ...
    <div class="col-md-4 g-5">
      <div class="card mt-4" style=" border-radius: 20px; background-color: bisque; ">
        ...
        <div class="card-body">
          ...
          <p class="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          <a href="{{ route('login') }}" class="btn btn-outline-dark d-block">Lihat Harga Paket</a>
          <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: larger;">
            50k
            <span class="visually-hidden">unread messages</span>
          </span>
    ...
    <div class="col-md-4 g-5">
      <div class="card mt-4" style="  border-radius: 20px; background-color: bisque;">
        ...
        <div class="card-body">
          ...
          <p class="card-text text-dark ">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          <a href="../sebelum_login/tips" class="btn btn-outline-dark d-block">Tips&Trik</a>
      </div> 
      </div>
    </div>
      <!--konten 2 bawah-->
      ...
      <div class="col-md-4 g-5" style="margin-bottom: 50px;">
        <div class="card mt-4" style=" border-radius: 20px; background-color: bisque;">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            <a href="../sebelum_login/gallery" class="btn btn-outline-dark d-block">Lihat Gallery</a>
              <span class="visually-hidden">unread messages</span>
            </span>
        </div>
        </div>
      ...
      <div class="col-md-4 g-5" style="margin-bottom: 50px;">
        <div class="card mt-4" style=" border-radius: 20px; background-color: bisque; ">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            <a href="{{ route('login') }}" class="btn btn-outline-dark d-block">Gabung Dengan Kami</a>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: larger;">
              Promo 
              <span class="visually-hidden">unread messages</span>
            </span>
      ...
      <div class="col-md-4 g-5" style="margin-bottom: 50px;">
        <div class="card mt-4" style="  border-radius: 20px; background-color: bisque;">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-dark ">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            <a href="{{ route('login') }}" class="btn btn-outline-dark d-block">Hubungi Kami</a>
        </div> 
        </div>
      </div>
